...
LIBERO_ROBOT_SDK_CONTRACT = {
    ...
    "methods":{
        ...
        "verify":{
            ...
            "deprecated":True,
            "replacement":"robot.check_observable_condition(verifier, payload)",
        ...
        "check_observable_condition":{
            "signature":"robot.check_observable_condition(condition, payload)",
            "returns":"sensor-only observable-condition result; never official task success",
            "output_fields":["verified","sensor_only","verifier_error","reason",
                              "criterion","target_xy_error_m","vertical_offset_m",
                              "source_vacated","nearest_source_detection_m",
                              "object_to_eef_distance_m","gripper_width_m","retained_width",
                              "object_count","object","target","eef_world_xyz",
                              "source_anchor_world_xyz","support_overlap_fraction",
                              "object_coverage_fraction","target_coverage_fraction",
                              "support_overlap_normalization","target_geometry_source",
                              "minimum_support_overlap","support_gap_m","support_gap_range_m",
                              "center_inside_target_bounds","target_count","target_anchor_world_xyz",
                              "target_association_rank","maximum_target_association_rank",
                              "support_height_source","support_plane_height_m",
                              "target_surface_height_error_m",
