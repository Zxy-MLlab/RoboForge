...
ROOT=pathlib.Path("/data/zxy/embodied_frontier/third_party/graspnet-baseline")
...
def main():
    ...
    ap.add_argument("--checkpoint",default="/data/zxy/embodied_frontier/checkpoints/graspnet-checkpoint-rs.tar")
